...
IMAGE_DEFAULT_R = 'aaltoscienceit/notebook-server-r-ubuntu:1.6.1'
IMAGE_DEFAULT_JULIA = 'aaltoscienceit/notebook-server-julia:1.6.0'
...
async def pre_spawn_hook(spawner):
    ...
    # Course configuration - only if it is a course
        ...
        for line in ['',
                     ...
                     'c.CourseDirectory.max_file_size = int(2*1024*(1024/1000.))+1',  #KB, translate to KiB
