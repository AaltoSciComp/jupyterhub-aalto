...
IMAGE_DEFAULT = 'aaltoscienceit/notebook-server:3.0.5'         # for generic images
IMAGE_COURSE_DEFAULT = 'aaltoscienceit/notebook-server:3.0.5'  # for courses
IMAGE_DEFAULT_R = 'aaltoscienceit/notebook-server-r-ubuntu:3.0.7'
